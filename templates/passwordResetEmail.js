              ...
              <div class="container">
                  ...
                  <div class="content">
                      <div class="message">
                          ...
                          <a href="${clientUrl}/setnewpassword?token=${token}" class="cta-button">Reset Your Password</a>
                          <p>
                              If you didn't request this, please ignore this email or <a href="mailto:${contactEmail}">contact us</a> if you have any concerns.
                          </p>
                      </div>
                  </div>
                  <div class="footer">
                      <p>&copy; 2024 Vendio. All rights reserved.</p>
                      <p>If you need further assistance, feel free to <a href="mailto:${contactEmail}">contact us</a>.</p>
                  </div>
              </div>
          </body>
          </html>
